...
In order for the cell to keep an organization of the different metabolic pathways, it needs to keeps them somewhat separate. This is done by **compartmentalizing** the cell, creating the **membrane-covered organnels**. Thus proteins can be sorted to their respective places by **sorting mechanism**. 
#### Compartments of the Cell
Membranes play a role in much more than the plasma membrane. Membrane-divided compartments include
- Mitochondria
- Endoplasmatic Reticulum - Smooth and rough
- Golgi apparatur
- Nucleus
- Lysosomes
- Peroxisomes
...
![417](z-Figures/Screenshot%202026-09-08%20at%2010.18.50.png)
...
![597](z-Figures/Screenshot%202026-09-08%20at%2012.24.34.png)

##### Transport of proteins
The three general distribution systems:
1. In vesicles - **The secretory pathway**
2. Across membranes directly using **translocation proteins**
3. Through pores in the double membrane of the nucleus
![245](z-Figures/Screenshot%202026-09-08%20at%2010.28.37.png)
...
- Co-translational translocation of proteins into the ER lumen
	- **Protein modifications** in the ER
- Transport to the Golgi apparaturs
	- Protein modifications in the Golgi apparatus and **intra Golgi transport** (From Cis-golgi to Trans-golgi (TGN))
- Transport from the Golgi apparatus
	- To the plasma membrane (**Exocytosis**) with **constitutive secretion** 
...
![Pasted image 20260908112208](z-Figures/Pasted%20image%2020260908112208.png)
...
- A free ribosome starts translating the mRNA sequence
- The $N^+$ terminus of the peptide chain forms a specific signal sequence, which is recognized by a **signal recognitions particle (SRP)** - this slows the synthesis
- This SRP then binds to an SRP receptor, which then connects the ribosome complex to a **protein translocator** or **translocon**
...
![408](z-Figures/Screenshot%202026-09-08%20at%2010.32.26.png)![401](z-Figures/Screenshot%202026-09-08%20at%2012.33.27.png)
...
![478](z-Figures/Screenshot%202026-09-08%20at%2010.38.13.png)![480](z-Figures/Screenshot%202026-09-08%20at%2010.38.20.png)
...
2. **GPI-anchoring** where a transmembrane protein is cleaved at the **C-terminal** (Transmembrane part), which is repalced by a glycosylphosphatidylinositol (GPI) - a **membrane lipid covalently linked to a carbohydrate** (phostphate). This called a GPI anchor.
	![601](z-Figures/Screenshot%202026-09-08%20at%2010.43.32.png)
...
3. The oxidation of **disulfide bridges** between the cysteine in the folded proteins. This is catalyzes by an **oxidized** protein disulfide isomerase (**PDI**), which binds to the cysteine, reduced, and the protein is oxidized.
	 ![382](z-Figures/Screenshot%202026-09-08%20at%2010.43.16.png)
...
4. **N-glycosylation**, which is where oligosaccharides are transfered  **en block** from a lipid precurser to the amide of **asparagin**. This is catalyzed by **oligosaccharyltransferase (OST)**
	...
	![244](z-Figures/Screenshot%202026-09-08%20at%2016.28.39.png)
...
5. **Proteolytic activation** - that is the cleavage of proproteins as a part of the maturity (Cleavage of signal peptide e.g.)

There is also systems in the lumen of the ER to **ensure proper folding**. 

Multiple chaperones act upon the newly synthesized protein:
- **BiP Chaperones** binds to the polypeptide chain to avoid **premature misfolding** just after synthesis
- **Lectins**, which binds to **monoglucosylated glycoproteins** (after N-glycosylation and glucosidase I and II trimming), perform the same role of assisting in folding
	- **Calnexin (CNX)** - A **membrane-bound** chaperone 
	- **Calreticulin (CRT)** - A **soluble** chaperone
	- **Glucosidase II** removes the last glucose, which **releases the proteins** form the lectins
- If the folding is correct, the proteins go on - but if it is misfolded the protein is **re-glycosylated** by **GDDP**, which means, that the lectins can bind again, to **retry folding**
...
![506](z-Figures/Screenshot%202026-09-08%20at%2010.49.14.png)

##### Vesicle Transport
The principles of vesicle transport is a part of a compartment, which include soluble and membrane cargo molecules, 
![615](z-Figures/Screenshot%202026-09-08%20at%2011.13.32.png)

#### Transport between ER and Golgi
The cytosol side of the membrane creates vesicles by budding, while becoming covered in a **COPII coat**. These are grouped in a vesicular tubular cluster, which can be recognized and moved along the microtubuli by the power of motor proteins. In the opposite directions (retrieval transport), the vesicles are coated in a **COPI coat**. 
![532](z-Figures/Screenshot%202026-09-08%20at%2011.17.17.png)
![570](z-Figures/Screenshot%202026-09-08%20at%2011.14.52.png)
...
Soluble proteins and membrane proteins enter the CGN via vesicles from the ER. Some of these contains **ER-retention signals** and are sent back instead of moving on in the golgi. 
- Here the oligosoccharides on **lysosomal proteins** are phosphorylized - this is called a **M6P tag**, which is signal for sending it on to the lysosomes
- We see **O-glycosylation** where GalNAc-transferases adds **GalNAc** to the hydroxyl group of **serine/threonine**

**(Cis/Medial/Trans) Cisternea**
- **N-Glycosylation continues** (Trimming Mannose), where **mannosidases** removes sugars from high-mannose N-glycans
- GlcNAc-transferases add **GlcNAc** to trimmed glycans.
- **Sulfotransferases** add sulfate (SO₄) to tyrosine or glycans

**Trans Golgi Network (TGN)**
- **Kinaser** phosphorylate serine/threonine/tyrosine on proteins.
- **Furin, PC1/3, PC2** cut proproteins to activate them
![475](z-Figures/Screenshot%202026-09-08%20at%2011.19.26.png)

In the TGN the proteins are sorted by **constitutive secretion** or **regulated secretion**.

**Constitutive secretion** means the the vesicles are uncoated and delivered directly to the membrane, where they are released by **exocytosis**. This is for example:
- Collagen, fibronectine, ion channels and receptors

**Regulated secretion** means that the vesicles are coated by **clathrine** until they are matured, at which point the clathrine is returned and they form **secretory granules**
- These are ready to be used in the given pathway (neurotransmitters, amylase, histamine, insulin, etc.). This includes proprotein processing - e.g. insulin which exists in the trans-golgi network as proinsulin, which is split to insulin and a C-peptide.

#### Membrane Fusion and Exocytosis
For both regulated and constitutive secretion, the exicytosis happens by fusion with the membrane
...
![Screenshot 2026-09-08 at 11.29.13](z-Figures/Screenshot%202026-09-08%20at%2011.29.13.png)

#### Endocytosis
There are multiple types of endocytosis
- **Pinocytosis** where fluid and small molecules (vesicles <150 nm diameter)
- **Phagocytosis** where larger particles with vesicles > 250 nm
- **Autophagi** which is the degration of the cells own organelles
- **Receptor-mediated endocytosis** which is when **clathrin coated pits** on the extracellular side of the membrane is budded into the cell.

![Screenshot 2026-09-11 at 14.42.03](z-Figures/Screenshot%202026-09-11%20at%2014.42.03.png)
...
- These are coated by **clathrine** and forms a bud
- The bud is released by **dynamin** and a clathrine coated vesicle is formed
- The calthrine-adaptin complexes release the receptors, and the transport vesicle is uncoated



The coats involved in the secretory pathway:
![Screenshot 2026-09-08 at 11.33.08](z-Figures/Screenshot%202026-09-08%20at%2011.33.08.png)
...
The **lysosome** in it self as the cells degradation centers
- There exists multiple pathways to the lysosomes. 
- Small (0.2 - 0.5 $\mu m$) spherical membrane structures
...
![Screenshot 2026-09-08 at 11.39.55](z-Figures/Screenshot%202026-09-08%20at%2011.39.55.png)![Screenshot 2026-09-08 at 11.40.13](z-Figures/Screenshot%202026-09-08%20at%2011.40.13.png)
...
![386](z-Figures/Screenshot%202026-09-08%20at%2011.43.50.png)
...
![700](z-Figures/Screenshot%202026-09-08%20at%2011.45.53.png)
...
- The precursor protein (with the signal peptide) is recognized by import receptor proteins, which is bound to the translocator in the outer membrane (**TOM**)
