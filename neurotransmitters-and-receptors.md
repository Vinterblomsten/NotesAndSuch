There are two types of receptors in the chemical synapsis
- **Ionotribe recetors** - fast
- **Metabotrope receptors** - (g-protein-coupled receptors) 
#### Pure Ionotrope Neurotramission
Some synapses are purely ionotrope. Which means that they **result in EPSPs or IPSPs**. These could use the neurotransmitters:
- Glutamte
- GABA
- Glycine
- Acetylcholine
#### Pure metabotrope transmission
These synapses have only indirect effect on $V_m$ - Could use the transmitters:
- **Noradrenelin (NA)** - or norepinephrine
- **Adrenalin** - or epinephrine
- **Dopamine (DA)**
- **Seretonin (5-HT)** - Sometimes
- **Aceptylcholin (Ach)**
- **Neuropeptides** - Exclusively used for metabotrope receptors. Includes:
	- Substans P
	- Encephalin
	- Edorphine

#### Mixed transmissions
These synapses use neurotransmitters, that can activate both ionotrope and metabotrope receptors:
- GABA
- Glutamate
- Achetylcholine
- Seretonine (5-HT) - Sometimes

#### G-protein coupled receptors (GPCRs)
These metabotropic receptors modulate activity by activating different kinds of **G-proteins**, when activated by their neurotransmitter. 
...
This is activated by $\beta$-adrenergic receptors (among others) and thus **noradrenalin**. 
- This activates the membrane bound **adenylate cyclase (AC)**
...
**Q G protein - $G_q$** (q?)
These are important as they effect the **phospholipase C (PLC)**. 
- Activated PLC cleaves **PIP2** into **DAG** and **IP3**
	- IP3 activates **$Ca^{2+}$ channels in the ER**, increasing the concentration of calcium
...
- **Transmitterreceptors** - Such as the **NMDA** receptor
...
- $GABA_A$ and $GABA_C$ are **ionotrope** and only on the **postsynaptic** cell
- $GABA_B$ is **metabotrope** and **both pre-and post synaptic**

When GABA is released:
- The postsynaptic ionotropic ($GABA_A$ and $GABA_C$) receptors allow $Cl^-$ influx leading to **IPSP**
- The **postsynaptic $GABA_B$** receptors signal the activation of $K^+$ channels leading to a second **delayed** IPSP - ($G_i$ coupled?)
...
- **AMPA**, **NMDA**: ionotrope
- **mGluR (1,2,3&5)**: metabotrope

When Glutamate is released:
On the postsynaptic side:
- The ionotrope **AMPA** is activated (by glutamate) allowing **influx of $Na^{2+}$** - EPSP.
- The ionotrope **NMPA** is in the beginning blocked by an $Mg^{2+}$, and won't open even with glutamate at the binding site - it's voltage-gated meaning that the $Mg^{2+}$ must be removed by depolarization to $\approx-20mV$
Nice figur fra bog? (3-24)
- The metabotrope **mGLUR1/5** is coupled to **$G_q$-protein** which activates PLC and PKC - affecting the NMPA and steadily depolarizing the membrane
- Upon enough depolarization of the postsynaptic membrane, NMPA will be **unclocked**, allowing **influx of $Ca^{2+}$** (and other cations), which is important for modulating synaptic functions (e.g. LTP)
...
4. NMDA-receptors and $Ca^{2+}$-chanels opens and leads to great $Ca^{2+}$-influx
5. The high intracellular concentration of $Ca^{2+}$ activates a lot of damaging enzymes resulting in necrosis (or apoptosis in less severe instances)

The gluatemate toxicity is called **excitotoxicity**: large concentrations of extracellular glutamate is toxic
#### Special synaptic transmissions
Some types of unorthodox transmission:
- Sometimes we have a **spillover**, where transmitters activate receptors outside of the synaptic cleft (**extrasynaptic receptors**)
...
- **SSRI** (Seretonin-reuptake inhibitirs): Inihibits reuptake of serotonin
- **Cocaine**: Inhibits the reuptake of dopamine

#### Serotonin system
The neurons with somas located in the **raphe nuclei** (about seven of them) is serotonergic
- Regulation fo sleep
- Regulation of appetite
- Emotions

**Depression** is often treated with **selective serotonin reuptake inhibitors (SSRI)**, increasing the presence of serotonin in the synaptic clefts and the extracellular space.
...
- From subtantia nigra to striatum
- Involved in movement
- Effect by parkinsons (loss of dopaminergic neruons)

The **mesocorticolimbic pathway**
- Frem **ventral tegmental area** to **nucleus accumbens** and **prefontal areas**
- Involed in motivation, reward - **prediction errors?**
- Addiction and schizophrenia

Some important receptors in the dopamine synapses is the
- **D1-like** receptors - **Postsynaptic metabotrope** receptor coupled to **$G_s$-protein**, leading to **activation** of AC and synthesis of cAMP (Excitatory)
...
- Anxiety
- Stress
Noradrenalin is also synthesized from tryptophan

The three main recepters of the noradrenalin synapses are:
- $\alpha1$ - **Postsynaptic** recepters coupled with **$G_{q}$-protein** -  
- $\alpha2$ - Pre- and postsynaptic recepters coupled to **$G_{i/o}$-protein** 
...
The **monoamine hypothesis** says that depression is a defect in one of the diffuse modulatory system
...
The endocannabinoids are involved in
- Modulation of learning (Inhibiting LTP)
- Appetite regulation
- Anxiety
- Autism perhaps?

The endocannabinoids are synthezised in the postsynaptic cells, upon activation of PLC, which catalyzes DAG, the precursor to endocannabinoid.
- For example by $G_q$-proteins of the mGluR1/5 receptor in glutamate synapses

**CB1 receptors** - **Presynaptic** receptors coupled to $G_i$, which inhibits the calcium channels, and thus inhibits the transmission strength 
