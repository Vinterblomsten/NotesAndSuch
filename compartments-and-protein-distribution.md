...
- Send a signal to stop the transcription of the misfolded accumulated protein
- In the worst case it will send signals to start apoptosis

The (smooth) ER also has a function of **synthesizing new lipids** and as a **storage of molecules such as $Ca^{2+}$**. 
...
- Here the oligosoccharides on **lysosomal proteins** are phosphorylized - this is called a Monose-6-phosphate **M6P tag**, which is signal for sending it on to the lysosomes
...
- **Pinocytosis** where fluid and small molecules (vesicles <150 nm diameter)
	- Spontaneous process 
	- Non-specialized - all cells do it
- **Phagocytosis** where larger particles with vesicles > 250 nm
	- This is **only specialized cells** such as in the immune system, where they can perform phagocytosis on bacteria
- **Receptor-mediated endocytosis** which is when **clathrin coated pits** on the extracellular side of the membrane is budded into the cell.
	- E.g. LDL particles from the blood stream
- **Autophagi** which is the degradation of the cells own organelles 
...
After excocytosis, the LDL-vesicles are sent to an **endosome**
- Here the acidic environment unbinds the LDL from the receptors
- The LDL-receptors are sent back to the plasma membrane in a vesicle called **recycling**
	- Other proteins can be sent to another location on the plasma membrane (important for epithel cells with tight junctions) - this is called **transcytosis**
- The LDL is passed on to the lysosomes to be degraded
...
- The precursor protein (with the signal peptide) is recognized by import receptor proteins called **importion**, which is binds to the translocator in the outer membrane (**TOM**)
