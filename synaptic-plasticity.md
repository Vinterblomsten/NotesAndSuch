Synaptic plasticity is an extremely central part of information processing and learning

#### Synaptic Strength
The synaptic strength is defined as the possibility for changing the firering of the action potentials of the postsynaptic strength
- For excitatory synapsis is it the size of the EPSP
- For inhibitory synapsis is it the size of the IPSP

### Short Term Plasticity 
The synapsis is stimulated very frequently - sometimes 100s of times a second
- This can change the strength of the synapsis - decreasing it step by step
- **Facilitation**: the stregth is increased by repetitive stimuli
- **Depression**: the strength is decreased by repetitive stimuli
- A synapsis can either have fascilitation and depression or both
...
Plasticity that doesn't disappear after the frequent action potentials disappear. Very important for **learning**. Can be hours, days, weeks, etc.

**Historic perspective**
Cajal proposed that learning was a results of new synapses being formed (1894 - sygt nok)

Hebbs proposed the  hebbian learning rule: "Cells that fire together, wire together" (1949)

H.M (Molaison) (1926-2008) removed the bi-latteral hippocampi - gained **full anterograde amnesia**
...
- activates **CaMKII** (Protein kinase)
	- CaMKII can **autophosphorylize** continuing the process after the residual $Ca^{2+}$ is gone
...
- Activating **Protein Phosphatase 1 - PP1**
- AMPA recepters are **dephosphorilized** and thus removed from the synapse by **endocytosis**

It is all dependent of the **calcium** concentration
- $[Ca^{2+}]\leq 1 \mu M$
...
#### Late LTP and LTD
While the effects of early LTP and LTD are clear, they only last in terms of minutes and hours, whereas we need memories for years. **Late LTP** involves modified gene transcription and protein sythesis through e.g. CREB.
- This serves function of memory consolidation (LTP) and refinement/differentiation (LTD)

#### Diseases of Plasticity
- **Alzheimer**'s disease: the protein aggregation **inhibits LTP in the hippocampus**
- **Depression**: is theorized to affect the LTP in the prefrontal cortex
	- TMS can induce LTD in the areas affected, forcing the neurons 
	- Serotonin also plads a role in plasticity, which is why serotonin uptake inhibition might help

#### (Extra Curriculum) Engrams are populations of nerves
Hopfieldian perspective of neural populations
